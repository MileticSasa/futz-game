...
func setup(context_player: Player, context_data: PlayerStateData, context_animation_player: AnimationPlayer, context_ball: Ball, context_area: Area2D, context_ball_detection: Area2D) -> void:
